...
import avatar from "../images/Jaya_Home.png";


const Hero = () => {
  
  const name = "Jaya Sukhwani".split("");
        ...
        <div className="grid items-center gap-5 mx-8 justify-items-center lg:grid-cols-2 ">
          {/*avatar*/}
            <div className=" w-[200px] md:w-[300px] lg:order-1 lg:w-[400px] xxl:w-[500px]">
              <motion.img
                ...
                src={avatar}
                alt="A fun vector image depicting Jaya Sukhwani"
              />
            </div>
          {/*text box*/}
          <div className="flex flex-col items-center gap-1 text-center md:gap-2 lg:items-end lg:text-right ">
            ...
            <motion.p
              ...
              viewport={{ once: false, amount: 0.7 }}
            >
              Data science and machine learning expert delivering impactful,  
              data-driven solutions in predictive analytics and automation.
            </motion.p>
            <Link to={"About"}>
              <motion.button
