        ...
        <div className="grid items-center gap-4 md:gap-6 lg:gap-8 justify-items-center lg:grid-cols-2">
          ...
          <div className=" w-[200px] md:w-[300px] lg:w-[400px] xxl:w-[500px]">
            <motion.img
              ...
              src={about}
              alt="A fun vector image depicting Jaya Sukhwani working on her pc"
            />
          </div>
          {/*text-box*/}
          <div className="grid items-center gap-1 md:gap-2 lg:gap-3 justify-items-center w-[300px] md:w-[400px]">
            ...
            <div className="flex flex-col text-justify text-neutral-500 ">
              <motion.p
                ...
                viewport={{ once: true, amount: 0.7 }}
              >
                I am a Data Science professional specializing in machine learning, 
                statistical modeling, and data visualization. With expertise in Python, SQL, 
                and advanced data analytics, I extract actionable insights from complex 
                datasets to drive business growth. My experience includes sales prediction, 
                fraud detection, and process automation, applying a data-driven approach 
                to build predictive models. I am constantly expanding my skills in data science, 
                staying up-to-date with the latest trends in artificial intelligence and 
                business intelligence to deliver innovative, high-performing solutions.
              </motion.p>
            </div>
            {/*cv button*/}
            <motion.div
